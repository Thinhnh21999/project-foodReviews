...
import { setAuthAction } from "../../Redux/action/index.js";
      ...
      <form className="bg-white rounded-2xl p-20 absolute text-center top-0 left-0 m-16 ">
        ...
        <div className="text-center mb-[135px]">
          <div className="mb-8">
            ...
            <p className="text-base font-normal text-p max-w-md">
          ...
          <div>
            <div className="mb-5">
              ...
              <div className="input">
                ...
                <input
                  onChange={(e) => handleChangeInput(e.target.value, "useName")}
          ...
          <p className="text-xs text-left text-primary font-bold mb-8">
            Forgot password?
          </p>
          <Btn
